...
public class RedisConfiguration {
    ...
    MessageListenerAdapter messageListenerAdapter(){
        return  new MessageListenerAdapter(new RedisMessageConfig(),"onMessage");
    }
    ...
    MessagePublisher messagePublisher(){
        return new RedisMessagePublisher(redisTemplate(redisConnectionFactory), (ChannelTopic) topic());
    }
}
